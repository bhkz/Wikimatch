...
/**
 * Variante "match" du badge démo. Comme DemoBadge, renvoie null en live mode.
 */
export default function MatchDemoBadge({
  text = "DÉMONSTRATION D’INTERFACE · SCÉNARIO FICTIF · AUCUNE DONNÉE RÉELLE",
}: { text?: string }) {
